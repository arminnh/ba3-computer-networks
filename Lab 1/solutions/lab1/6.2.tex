...
We expected the pings to 10.0.1.11 to go through the network (eth0), unlike the pings to 
127.0.0.1, but we noticed they both went through the loopback interface. 
